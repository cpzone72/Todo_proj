...
def create_bmt_checklist_v2():
    ...
    checklist_data = [
        ...
        ("D. 지능형 기능", "D-5", "차량번호 인식", "LPR 인식률", "주간/야간 차량 진입 시 번호 추출 정확도", "정지/저속 시 인식률 95% 이상", "", ""),
        ("D. 지능형 기능", "D-6", "번호판 검색", "LPR Search", "저장 영상에서 특정 번호 검색", "검색 즉시 해당 차량 영상 표출", "", ""),
        ("D. 지능형 기능", "D-7", "차단기 연동", "Allow/Block List", "등록 차량 진입 시 알람 아웃 동작 확인", "화이트리스트 진입 시 차단기 신호 발생", "", ""),
    ...
    file_name = "NVR3864-V6-IQ_BMT_Checklist_v2.xlsx"
    wb.save(file_name)
    print(f"Excel file saved as {file_name}")

if __name__ == "__main__":
    create_bmt_checklist_v2()
